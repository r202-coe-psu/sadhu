...
class ScoreBoard:
    ...
    def display_text(self, data):
        ...
        return f'{data["name"]}\n{float(data["score"]):.02f}/{data["max_score"]} ({data["complete"]}/{data["challenges"]})'
    ...
    def update(self, key, data):
        ...
        obj.set({"text": self.display_text(data)})
    ...
    def get_student_scores(self):
        ...
        request = ajax.get(self.data_url, oncomplete=self.on_ajax_complete)
